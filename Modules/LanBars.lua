...
--~ LanBar1 = CreateFrame('frame', LanBar1, UIParent)
...
--~ 		for i = 1, 12 do
--~ 			button = _G["ActionButton"..i]
--~ 			button:SetSize(LanConfig.ActionBars.ButtonSize, LanConfig.ActionBars.ButtonSize)
--~ 			button:ClearAllPoints()
--~ 			button:SetParent(bar)
--~ 			button:SetFrameStrata("BACKGROUND")
--~ 			button:SetFrameLevel(15)
--~ 			if i == 1 then
--~ 				button:SetPoint("BOTTOMLEFT", LanConfig.ActionBars.ButtonSpacing, LanConfig.ActionBars.ButtonSpacing)
--~ 			else
--~ 				local previous = _G["ActionButton"..i-1]
--~ 				button:SetPoint("LEFT", previous, "RIGHT", LanConfig.ActionBars.ButtonSpacing, 0)
--~ 			end
--~ 		end
