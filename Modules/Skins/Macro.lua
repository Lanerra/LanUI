...
local function LoadSkin()
	...
	MacroNewButton:Point('BOTTOMRIGHT', MacroFrame, -90, 4)
	...
	MacroFrame:SetTemplate()
	MacroFrameTextBackground:StripTextures()
	MacroFrameTextBackground:CreateBD()
	MacroButtonScrollFrame:CreateBD()
	MacroPopupFrame:StripTextures()
	MacroPopupFrame:SetTemplate()
	MacroPopupScrollFrame:StripTextures()
	MacroPopupScrollFrame:CreateBD()
	MacroPopupScrollFrame:SetTemplate(true)
	MacroPopupScrollFrame.backdrop:Point('TOPLEFT', 51, 2)
	MacroPopupScrollFrame.backdrop:Point('BOTTOMRIGHT', -4, 4)
	MacroPopupEditBox:CreateBD()
	MacroPopupEditBox:StripTextures()
	MacroPopupEditBox.backdrop:SetTemplate(true)
	...
	MacroFrameSelectedMacroButton:SetTemplate(true)
