...
local function LoadSkin()
	HandleCloseButton(SpellBookFrameCloseButton)
	...
	HandleNextPrevButton(SpellBookPrevPageButton)
	HandleNextPrevButton(SpellBookNextPageButton)
	...
	--Bottom Tabs
	for i=1, 5 do
		HandleTab(_G["SpellBookFrameTabButton"..i])
	end
