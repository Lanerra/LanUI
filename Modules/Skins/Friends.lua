...
local function LoadSkin()
	...
	ChannelFrameDaughterFrame:CreateBD(true)
	...
	for i=1, 4 do
		...
		if i ~= 1 then
			_G['FriendsFrameTab'..i]:Point('LEFT', _G['FriendsFrameTab'..i - 1], 'RIGHT', 4, 0)
		end
	end
	...
	for i=1, 3 do
		...
		if i ~= 1 then
			_G['FriendsTabHeaderTab'..i]:Point('LEFT', _G['FriendsTabHeaderTab'..i - 1], 'RIGHT', 4, 0)
		end
	end
	...
	local function Channel()
		for i=1, MAX_DISPLAY_CHANNEL_BUTTONS do
			...
			if button then
				...
				_G['ChannelButton'..i..'Text']:FontTemplate(C.Media.Font, 12)
			end
		end
	end
	hooksecurefunc('ChannelList_Update', Channel)

	FriendsFriendsFrame:CreateBD(true)
