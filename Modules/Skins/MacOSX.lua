...
local function LoadSkin()
	...
	if IsMacClient() then
		...
		MacOptionsFrameMovieRecording:SetTemplate()
		MacOptionsITunesRemote:SetTemplate()

		--Skin buttons
		F.SkinButton(_G['MacOptionsFrameCancel'])
		F.SkinButton(_G['MacOptionsFrameOkay'])
		F.SkinButton(_G['MacOptionsButtonKeybindings'])
		F.SkinButton(_G['MacOptionsFrameDefaults'])
		F.SkinButton(_G['MacOptionsButtonCompress'])
