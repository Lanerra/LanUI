...
local function LoadSkin()
	...
	for i=1,7 do
		...
		_G['ClassTrainerScrollFrameButton'..i]:CreateBD()
		_G['ClassTrainerScrollFrameButton'..i].backdrop:SetTemplate(true)
	...
	ClassTrainerFrame:CreateBD()
	ClassTrainerFrame.backdrop:SetTemplate(true)	
	...
	ClassTrainerFrameSkillStepButton:CreateBD()
	ClassTrainerFrameSkillStepButton.backdrop:SetTemplate(true)
	...
	ClassTrainerStatusBar:CreateBD()
end
