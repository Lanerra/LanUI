...
local function LoadSkin()
	...
	HandleCloseButton(MissingLootFramePassButton)
	...
	HandleCloseButton(LootHistoryFrame.CloseButton)
	LootHistoryFrame:StripTextures()
	LootHistoryFrame:SetTemplate('Transparent')
	HandleCloseButton(LootHistoryFrame.ResizeButton)
	...
	HandleScrollBar(LootHistoryFrameScrollFrameScrollBar)
	...
	hooksecurefunc("MasterLooterFrame_Show", function()
		...
		if b then
			...
			b:StripTextures()
			i:SetTexture(icon)
			i:SetTexCoord(unpack(F.TexCoords))
			b:CreateBackdrop()
	...
	HandleCloseButton(LootFrameCloseButton)

	LootFrame:SetTemplate("Transparent")
	LootFramePortraitOverlay:SetParent(LanUIHider)
	...
	for i=1, LOOTFRAME_NUMBUTTONS do
		...
		_G["LootButton"..i.."IconQuestTexture"]:SetParent(LanUIHider)
	...
	HandleNextPrevButton(LootFrameDownButton)
	HandleNextPrevButton(LootFrameUpButton)
