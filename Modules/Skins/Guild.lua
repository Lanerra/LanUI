...
local function LoadSkin()
	...
	GuildNewsBossModelTextFrame:CreateBD()
	...
	GuildFactionBar:CreateBD()
	GuildFactionBar:SetTemplate(true)
	...
	GuildLatestPerkButton:CreateBD()
	GuildLatestPerkButton:SetTemplate(true)
	...
	GuildNextPerkButton:CreateBD()
	GuildNextPerkButton:SetTemplate(true)
	...
	for i=1,5 do
		...
		GuildFrameTab1:Point('BOTTOMLEFT', GuildFrame, 5, -30)
		if i ~= 1 then
